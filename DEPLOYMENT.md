...
2. Open the SQL editor and run `supabase/migrations/0001_init.sql`. This creates all tables, enums, RLS policies, triggers, and the `attachments` storage bucket.
